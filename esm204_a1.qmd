...
#plot demand_df
colors <- c("Original Demand" = "red", "New Demand" = "blue", "Aggregate Demand" = "green", "Supply" = "pink")
ggplot(demand_df, aes(y = P))+
  ...
  geom_point(aes(x = 3300, y = 170), size = 1) +
  geom_point(aes(x = 3375.41, y = 173.7705), size = 1) +

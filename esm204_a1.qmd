...
ggplot(demand_df, aes(y = P))+
  ...
  geom_line(aes(x = supply), color = "pink")+
...
i.  Use R to calculate the elasticity of supply of inefficient cars, evaluated at the market equilibrium.

    ```{r}
#calculate the derivative of the supply function Q=5P-1000^5/6
  
flipped_supply=expression((5p-1000)^5/6)

    ```

ii. What are the benefits of this policy to owners of old cars?

iii. What is the cost of this program to taxpayers (who fund the government
